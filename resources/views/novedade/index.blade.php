        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('novedades.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('Novedade')</h3>
                        </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-auto text-muted">
                                    ...
                                    <div class="ms-2 d-inline-block">
                                        <form action="{{ route('novedades.index') }}" method="GET" class="form-inline">
                        ...
                        <div class="table-responsive min-vh-100">
                            <table class="table card-table table-vcenter text-nowrap datatable">
                                ...
                                <tbody>
                                @forelse ($novedades as $novedade)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select novedade"></td>
                                        <td>{{ ++$i }}</td>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('novedades.show',$novedade->id) }}">
                                                           @lang('View')
                                                        </a>
                                                        <a class="dropdown-item"
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $novedades->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
