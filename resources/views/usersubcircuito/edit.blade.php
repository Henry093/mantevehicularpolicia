...
@section('title', __('validation.Update Usersubcircuito'))
            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST"
                                  action="{{ route('usersubcircuitos.update', $usersubcircuito->id) }}" id="ajaxForm" role="form"
                                  enctype="multipart/form-data">
                                {{ method_field('PATCH') }}
                                @csrf
                                @include('usersubcircuito.form')
                            </form>
                        </div>
                    </div>
                </div>
