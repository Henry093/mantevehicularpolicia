...
@section('title', __('validation.Update Rmantenimiento'))
            ...
            <div class="row row-deck row-cards">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form method="POST"
                                  action="{{ route('rmantenimientos.update', $rmantenimiento->id) }}" id="ajaxForm" role="form"
                                  enctype="multipart/form-data">
                                {{ method_field('PATCH') }}
                                @csrf
                                @include('rmantenimiento.form')
                            </form>
                        </div>
                    </div>
                </div>
