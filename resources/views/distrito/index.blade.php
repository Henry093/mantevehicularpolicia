        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('distritos.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-auto text-muted">
                                    ...
                                    <div class="ms-2 d-inline-block">
                                        <form action="{{ route('distritos.index') }}" method="GET" class="form-inline">
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $distritos->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
