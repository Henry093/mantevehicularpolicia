                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('Marca')</h3>
                        </div>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-auto text-muted">
                                    ...
                                    <div class="ms-2 d-inline-block">
                                        <form action="{{ route('marcas.index') }}" method="GET" class="form-inline">
                                ...
                                @forelse ($marcas as $marca)
                                    <tr>
                                        <td><input class="form-check-input m-0 align-middle" type="checkbox"
                                                   aria-label="Select marca"></td>
                                        <td>{{ ++$i }}</td>
                                        
											<td>{{ $marca->tvehiculo->nombre }}</td>
											<td>{{ $marca->nombre }}</td>
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $marcas->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
