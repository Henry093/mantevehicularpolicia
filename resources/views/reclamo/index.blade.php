        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('reclamos.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">@lang('Reclamo')</h3>
                        </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-end">
                                                        <a class="dropdown-item"
                                                           href="{{ route('reclamos.show',$reclamo->id) }}">
                                                            @lang('View')
                                                        </a>
                                                        <a class="dropdown-item"
                                                           href="{{ route('reclamos.edit',$reclamo->id) }}">
                                                            @lang('Edit')
                                                        </a>
                                                        <form
                                                            action="{{ route('reclamos.destroy',$reclamo->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="submit"
